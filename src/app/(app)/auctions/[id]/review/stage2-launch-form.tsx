  ...
  return (
    <form action={action} className="space-y-3">
      ...
      <div className="space-y-2">
        <Label htmlFor="targetRate">Single counter rate (₹/{unit})</Label>
        <Input id="targetRate" name="targetRate" type="number" step="0.01" min="0" placeholder={lowest} required />
        <p className="text-xs text-muted-foreground">
          Blasted to all participants for one 24-hour round. Sellers may accept, reject, or submit a
          final rate no higher than their Stage-1 bid.
        </p>
      </div>
